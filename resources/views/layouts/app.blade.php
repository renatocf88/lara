...
<head>
    ...
    <title>{{-- config('app.name', 'Laravel') --}} Escola</title>
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-11">
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message float-right">
                ...
                <div class="col-sm-1">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                                <a class="nav-link" href="#"><i class="fa fa- user"></i>Notificação <span class="count">13</span></a>
